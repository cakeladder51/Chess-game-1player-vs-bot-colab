...
wpi = pygame.transform.scale(pygame.image.load("Chess bot folder\white_pawn.png"), (square_size, square_size))
bpi = pygame.transform.scale(pygame.image.load("Chess bot folder\Black_pawn.png"), (square_size, square_size))
wri = pygame.transform.scale(pygame.image.load("Chess bot folder\white_rook.png"), (square_size, square_size))
bri = pygame.transform.scale(pygame.image.load("Chess bot folder\Black_rook.png"), (square_size, square_size))
wki = pygame.transform.scale(pygame.image.load("Chess bot folder\white_knight.png"), (square_size, square_size))
bki = pygame.transform.scale(pygame.image.load("Chess bot folder\Black_knight.png"), (square_size, square_size))
wbi = pygame.transform.scale(pygame.image.load("Chess bot folder\white_bishop.png"), (square_size, square_size))
bbi = pygame.transform.scale(pygame.image.load("Chess bot folder\Black_bishop.png"), (square_size, square_size))
wqi = pygame.transform.scale(pygame.image.load("Chess bot folder\white_queen.png"), (square_size, square_size))
bqi = pygame.transform.scale(pygame.image.load("Chess bot folder\Black_queen.png"), (square_size, square_size))
wkii = pygame.transform.scale(pygame.image.load("Chess bot folder\white_king.png"), (square_size, square_size))
bkii = pygame.transform.scale(pygame.image.load("Chess bot folder\Black_king.png"), (square_size, square_size))
